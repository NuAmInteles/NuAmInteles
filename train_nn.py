...
#script to be placed unde deepspeech.pytorch
def train_nn(hidden_layers=None, hidden_size=None, lr=None, epochs=None, batch_size=None, augment=None):
...
#                     (epoch + 1), (i + 1), len(train_sampler), batch_time=batch_time, data_time=data_time, loss=losses))
    ...
    #return loss_results, wer_results, cer_results
    return cer_results[-1]
